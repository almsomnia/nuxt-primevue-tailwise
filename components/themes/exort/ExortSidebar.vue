...
<template>
   ...
   >
      <div
         :class="[
            'relative flex h-full w-[275px] flex-col overflow-hidden rounded-none border-r border-dashed border-slate-300/70 bg-gradient-to-b from-slate-100 to-slate-50 transition-[width,margin] duration-300 xl:ml-0 group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:border-solid group-[.side-menu--collapsed.side-menu--on-hover]:xl:shadow-[6px_0_12px_-4px_#0000000f]',
