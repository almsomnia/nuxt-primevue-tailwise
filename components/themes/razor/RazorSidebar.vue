...
<template>
   <div
      :class="[
         'box from-primary-500 to-primary-800 relative z-20 flex h-full w-[275px] flex-col overflow-hidden rounded-none border-0 bg-gradient-to-b transition-[width] duration-300 xl:rounded-xl group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:shadow-[6px_0_12px_-4px_#0000000f]',
