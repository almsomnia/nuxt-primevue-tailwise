...
<template>
   <div
      class="absolute inset-y-0 z-10 xl:top-[65px] xl:z-0 xl:py-3.5"
      @mouseover.prevent="compactMenu.onHover = true"
      @mouseleave.prevent="compactMenu.onHover = false"
   >
      <div
         :class="[
            'box relative flex h-full w-[275px] flex-col overflow-hidden rounded-none transition-[width,margin] duration-300 xl:ml-5 xl:rounded-xl group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:shadow-[6px_0_12px_-4px_#0000000f]',
