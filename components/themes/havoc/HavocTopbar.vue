...
<template>
   <div
      class="from-primary-500 to-primary-800 fixed inset-x-0 top-0 z-10 flex h-[65px] bg-gradient-to-r shadow-lg"
   >
      <div
         :class="[
            'relative z-10 ml-5 flex h-full flex-none items-center overflow-hidden pr-5 pl-0.5 duration-300 xl:w-[275px] group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:shadow-[6px_0_12px_-4px_#0000001f]',
      ...
      >
         <a
            href=""
            class="hidden items-center transition-[margin] xl:flex group-[.side-menu--collapsed]:xl:ml-8 group-[.side-menu--collapsed.side-menu--on-hover]:xl:ml-0"
         >
            <div
