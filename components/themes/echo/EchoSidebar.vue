...
<template>
   <div
      :class="[
         'box relative z-20 flex h-full w-[275px] flex-col overflow-hidden rounded-none bg-white/[0.95] transition-[width] duration-300 xl:rounded-xl group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:shadow-[6px_0_12px_-4px_#0000000f]',
      ]"
   ...
   >
      <div
         :class="[
            'relative z-10 hidden h-[65px] w-[275px] flex-none items-center overflow-hidden px-5 duration-300 xl:flex group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px]',
         ]"
      >
         <a
            href=""
         ...
         >
            <div
               class="from-primary-500 to-primary-800/80 flex h-[34px] w-[34px] items-center justify-center rounded-lg bg-gradient-to-b transition-transform ease-in-out group-[.side-menu--collapsed.side-menu--on-hover]:xl:-rotate-180"
            >
               <div
