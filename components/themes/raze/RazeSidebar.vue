...
<template>
   <div
      :class="[
         'from-primary-500 to-primary-800 relative z-20 flex h-screen w-[275px] flex-col overflow-hidden bg-gradient-to-b transition-[width] duration-300 xl:rounded-[0_1.2rem_1.2rem_0/0_1.7rem_1.7rem_0] group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:shadow-[6px_0_12px_-4px_#0000000f]',
