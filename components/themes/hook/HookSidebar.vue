...
<template>
   <div
      :class="[
         'relative z-20 flex h-screen w-[275px] flex-col border-slate-200/80 transition-[width] duration-300 group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:shadow-[6px_0_12px_-4px_#0000000f]',
         'before:from-primary-500 before:to-primary-800 before:absolute before:inset-0 before:border-slate-200/80 before:bg-gradient-to-b before:content-[\'\'] before:xl:rounded-[0_0.75rem_0.75rem_0/0_1.1rem_1.1rem_0] before:group-[.side-menu--collapsed.side-menu--on-hover]:xl:shadow-[6px_0_12px_-4px_#0000000f]',
         'after:bg-texture-white after:absolute after:inset-0 after:bg-contain after:bg-fixed after:bg-[center_-20rem] after:bg-no-repeat after:content-[\'\'] after:xl:-mr-4',
      ]"
